...
namespace bl3guns.Items
{
    public class hellshock : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Shock projectile ricochets into fire, dealing double damage\n'I had not thought death had undone so many.'");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            Main.PlaySound(mod.GetSoundSlot(SoundType.Item, "Sounds/Item/hellshock"), (int)player.Center.X, (int)player.Center.Y);
