...
namespace bl3guns.Items
{
    public class nightHawkin : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Night Hawkin");
            Tooltip.SetDefault("Burst fires cryo bullets\nIgnites enemies at night\n'Stranger than things.'");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                type = mod.ProjectileType("hawkinProj");
            }
        ...
        {
            Main.PlaySound(SoundID.Item61, (int)player.Center.X, (int)player.Center.Y);
