...
{
    public class psychoStabber : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Psycho Stabber [WIP]");
            Tooltip.SetDefault("Launches knives as bullets\nAlt-Fire: Stab at a very fast rate, dealing melee damage\n'Fa fa fa fa, fa fa fa fa fa fa...'");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            {
                type = mod.ProjectileType("psychoProj");
            }
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            else
            {
                ...
                item.useAmmo = AmmoID.Bullet;
                item.shoot = mod.ProjectileType("psychoProj");
                item.shootSpeed = 18f;
        ...
        public override void UseStyle(Player player)
        {
            if (player.altFunctionUse == 2)
            {
                ...
                //player.itemLocation.X = itemLocation.X + 8f;
                //player.itemLocation.Y = itemLocation.Y + 12f;
            }
        }
