...
{
    public class kaoson : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Kaoson");
            Tooltip.SetDefault("Enemy hits spawn grenades, dealing massively increased damage\n'Small but packs a punch.'");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/cut61");
            item.autoReuse = true;
