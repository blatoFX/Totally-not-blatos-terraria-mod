		...
		public override void Kill(int timeLeft)
		{
			...
			if (projectile.owner == Main.myPlayer)
			{
				...
				for (int i = 0; i < 3; i++)
				{
					...
					float speedX = 0;
					float speedY = 0;
					Projectile.NewProjectile(projectile.position.X + newPosX, projectile.position.Y + newPosY, speedX, speedY, mod.ProjectileType("flakkerExplosion"), (int)(projectile.damage * 0.6), 0f, projectile.owner, 0f, 0f);
				}
			}
		}
	}
